...
class FaceLandmarkDetector:
    ...
    def _init_onnx_detector(self):
        ...
        # 初始化ONNX运行时会话
        self.face_detector = ort.InferenceSession(self.face_detector_path, sess_options=session_options, providers=providers)
        self.face_detector_input_name = self.face_detector.get_inputs()[0].name

        self.landmark_detector = ort.InferenceSession(self.landmark_detector_path, sess_options=session_options, providers=providers)
